...
Revision ID: a3fcda06cc07
Revises: 
Create Date: 2022-05-01 11:22:30.847668
...
def upgrade():
    ...
    sa.Column('premium_account', sa.Boolean(), nullable=False),
    ...
    sa.Column('raw_body', sa.UnicodeText(), nullable=False),
